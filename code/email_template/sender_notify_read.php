...
$message_join .= "
   ...
   <td  style='background-color:white; padding:15px; width:50%; vertical-align:top; '>
    <div style='background-color:#F2F2F2; border-radius:5px; padding:10px; font-family:arial; font-size:14px;' >
        Hi, <br />As requested we are notifying you that - <strong style='color:blue;'>".$from_user."</strong><br />
         has read the email that include the file: <br /> <br /> <strong>".$filename."</strong> <br /> <br /> you sent him. 
    </div>
   </td>
   <td  style='background-color:white; padding:15px; width:50%; vertical-align:top;'>
    <div style='background-color:#F2F2F2; border-radius:5px; padding:10px; font-family:arial; font-size:14px' >
        Your confirmation token is: <br /><br />&nbsp;&nbsp;&nbsp;&nbsp;<strong>".$confirm."</strong><br /><br /> Have a nice day.
        <br/>";
