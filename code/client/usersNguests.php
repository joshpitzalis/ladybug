...
if (isset($uname)&&$uname!='nouser') {
    ...
    //User Loged Display user page:
    include("code".DS."client".DS."usersOnlyPage.php");  
    
} else { //User Not Loged Display guest page:
...
<body>
    <div class='outerContainer'>
        <form action='index.php' method='POST' class='hiddder' id='login_form_user'>
            <table border='0'>
                <tr>
                    <td colspan='3'>
                        <div class='logoTakeThat'>
                            <a href='index.php'>
                                <img src='img/takethatlogo.png' style="border:0" />
                            </a>
                        </div>
...
<table border='0' class='graber' grab="top2-" >
    <tr>
        <td colspan='3'>
            <a alt='Log In' title='Log In' class='loginbutton button facebook' id='logMeIn'><?php echo $lang[$lang['set']]['type_login_button']; ?></a>
