...
if($_GET['action'] == 'inserttabledata') {	
	...
	$mysqli->query("INSERT INTO `$table_settings` (`id`, `site_name`, `site_title`, `site_desc`, `site_url`, `max_size`, `blocked_types`, `expire`, `upload_dir`, `favicon_path`, `logo_path`, `language`, `bg_timer`, `email_from_name`, `email_from_email`, `email_server`, `smtp_host`, `smtp_auth`, `smtp_secure`, `smtp_port`, `smtp_username`, `smtp_password`) VALUES
					(1, 'Droppy', 'Droppy - Online file sharing', 'Online file sharing, share large or small files with friends and family.', '$site', 20, 'image/bmp,image/bmp,application/exe', 86400, 'uploads/', 'src/images/icon.png', 'src/images/logo.png', 'English.php', 20000, 'No-Reply Example', 'noreply@example.com', 'LOCAL', '', 'true', 'tls', 25, '', '');");
	...
	$mysqli->query("INSERT INTO `$table_templates` (`id`, `type`, `msg`) VALUES
					(1, 'receiver', 'No email template has been set, see droppy demo for examples'),
					(2, 'sender', 'No email template has been set, see droppy demo for examples'),
					(3, 'destroyed', 'No email template has been set, see droppy demo for examples'),
					(4, 'downloaded', 'No email template has been set, see droppy demo for examples'),
					(5, 'receiver_subject', 'You have received some files !'),
					(6, 'sender_subject', 'Your items have been sent !'),
					(7, 'destroyed_subject', 'Your items have been destroyed !'),
					(8, 'downloaded_subject', 'Someone has downloaded your items !');");
